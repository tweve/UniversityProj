		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="bByClass1.jsp">Diseases</a></li>
					<li class="active"><a href="Family.jsp">Plants</a></li>
...
/* 				String genero = "PREFIX medicinal_plants: <http://www.owl-ontologies.com/Plantas.owl#>"
						+ "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>"
						+ "prefix rdf:    <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"
						+
						"SELECT distinct ?gendre ?gendrelabel WHERE { ?plant medicinal_plants:hasClassification ?genre ."
						//+ "?family rdf:type medicinal_plants:Family ."
						//+ "?family rdfs:label ACANTHACEAE ."
						//+ "?plant medicinal_plants:hasClassification ?genre ."
						+ "?genre rdf:type medicinal_plants:Genre ."
						+ "?genre rdfs:label ?genrelabel ."
						+ "}";
								
				Query query1 = QueryFactory.create(genero);
