...
# Modified by Rui Lopes on 2012-02-20
# Added support for ghost agent arguments
...
def readCommand( argv ):
  ...
  parser.add_option('--ghostArgs',dest='ghostArgs',
                    help='Comma separated values sent to ghost agents. e.g. "opt1=val1,opt2,opt3=val3"')
